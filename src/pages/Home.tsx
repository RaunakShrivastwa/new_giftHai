  ...
  return (
    <main className="text-foreground">
        ...
        <div className="w-full mx-auto px-6">
          <div className="grid grid-cols-4 md:grid-cols-8 gap-3 md:gap-5">
            {[
              ...
              <Link
                key={c.label}
                to={c.cat ? `/products?category=${c.cat}` : "/products"}
                className="group text-center"
              >
                <div
                  className="aspect-square rounded-2xl overflow-hidden mb-2 shadow-sm transition-shadow"
        ...
        <div className="w-full mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-muted-foreground">
              Each collection is thoughtfully curated for that special someone
              in your life.
            </p>
          </div>
      ...
      <section
        ...
        style={{ background: "var(--pink-50)", borderColor: "var(--pink-100)" }}
      >
        <div className="w-full mx-auto px-6 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {PROMISES.map((p) => (
            <div key={p.title} className="text-center sm:text-left">
              <div
                className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-white border mb-4 shadow-sm"
                style={{
